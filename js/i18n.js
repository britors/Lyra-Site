(() => {
  ...
  const catalogs = {
    'en-US': {
      ...
      'Prévia ilustrativa do desktop GNOME com branding Lyra OS': 'Illustrative preview of the GNOME desktop with Lyra OS branding',
      ...
      'Fim de suporte da Lyra OS 1.0': 'End of support for Lyra OS 1.0', 'Fim de suporte da Lyra OS Server 1.0': 'End of support for Lyra OS Server 1.0',
      'Suporte encerra em 31 de outubro de 2027, junto com o fim de vida da base openSUSE Leap 16.0; a migração para a Lyra OS 1.1 (base Leap 16.1) deve ocorrer antes dessa data.': 'Support ends on October 31, 2027, alongside the end of life of the openSUSE Leap 16.0 base; migration to Lyra OS 1.1 (Leap 16.1 base) must take place before that date.',
      'Suporte encerra em 31 de outubro de 2027, junto com o fim de vida da base openSUSE Leap 16.0; a migração para a Lyra OS Server 1.1 (base Leap 16.1) deve ocorrer antes dessa data.': 'Support ends on October 31, 2027, alongside the end of life of the openSUSE Leap 16.0 base; migration to Lyra OS Server 1.1 (Leap 16.1 base) must take place before that date.',
      ...
      'O ciclo começa cerca de um mês após a versão 1.0. A mudança de base exige revalidar pacotes, ABI, shim de Secure Boot e a matriz de hardware.': 'The cycle begins about one month after version 1.0. The base change requires revalidating packages, ABI, the Secure Boot shim, and the hardware matrix.',
      'EOL · ESTIMATIVA': 'EOL · ESTIMATE', 'Fim de suporte da Lyra OS 1.1': 'End of support for Lyra OS 1.1', 'Fim de suporte da Lyra OS Server 1.1': 'End of support for Lyra OS Server 1.1',
      ...
      '14 ago 2026': 'Aug 14, 2026', '17 ago 2026': 'Aug 17, 2026', '28 ago – 11 set 2026': 'Aug 28 – Sep 11, 2026',
      ...
      '26 jul – 09 ago 2027': 'Jul 26 – Aug 9, 2027', '09 – 23 ago 2027': 'Aug 9–23, 2027', '~06 set 2027': '~Sep 6, 2027',
  ...
  Object.assign(catalogs['es-ES'], catalogs['en-US'], {
    ...
    ,'01 – 22 mar 2027':'1–22 mar 2027','22 mar – 12 abr 2027':'22 mar – 12 abr 2027','12 abr – 03 mai 2027':'12 abr – 3 may 2027','03 – 31 mai 2027':'3–31 may 2027','31 mai – 28 jun 2027':'31 may – 28 jun 2027','28 jun – 26 jul 2027':'28 jun – 26 jul 2027','26 jul – 09 ago 2027':'26 jul – 9 ago 2027','09 – 23 ago 2027':'9–23 ago 2027','~06 set 2027':'~6 sept 2027'
  });
  ...
  Object.assign(catalogs['es-ES'], {
    ...
    'Prévia ilustrativa do desktop GNOME com branding Lyra OS':'Vista previa ilustrativa del escritorio GNOME con la identidad de Lyra OS','Bom dia, Rodrigo':'Buenos días, Rodrigo','em harmonia.':'en armonía.','Em breve':'Próximamente',
    ...
    'Descrição: o Lyra OS 1.0 oferece en-US, pt-BR e es-ES; outros idiomas ficam para ciclos futuros. O fluxo NVIDIA segue para a Alpha 5.':'Descripción: Lyra OS 1.0 ofrece en-US, pt-BR y es-ES; los demás idiomas quedan para ciclos futuros. El flujo de NVIDIA pasa a Alpha 5.',
  ...
  Object.assign(catalogs['es-ES'], {
    'Fim de suporte da Lyra OS 1.0':'Fin del soporte de Lyra OS 1.0','Suporte encerra em 31 de outubro de 2027, junto com o fim de vida da base openSUSE Leap 16.0; a migração para a Lyra OS 1.1 (base Leap 16.1) deve ocorrer antes dessa data.':'El soporte termina el 31 de octubre de 2027, junto con el fin de vida de la base openSUSE Leap 16.0; la migración a Lyra OS 1.1 (base Leap 16.1) debe realizarse antes de esa fecha.',
    ...
    'Fim de suporte da Lyra OS Server 1.0':'Fin del soporte de Lyra OS Server 1.0','Suporte encerra em 31 de outubro de 2027, junto com o fim de vida da base openSUSE Leap 16.0; a migração para a Lyra OS Server 1.1 (base Leap 16.1) deve ocorrer antes dessa data.':'El soporte termina el 31 de octubre de 2027, junto con el fin de vida de la base openSUSE Leap 16.0; la migración a Lyra OS Server 1.1 (base Leap 16.1) debe realizarse antes de esa fecha.',
    ...
    'rebase para openSUSE Leap 16.1':'cambio de base a openSUSE Leap 16.1','O ciclo começa cerca de um mês após a versão 1.0. A mudança de base exige revalidar pacotes, ABI, shim de Secure Boot e a matriz de hardware.':'El ciclo comienza aproximadamente un mes después de la versión 1.0. El cambio de base exige volver a validar paquetes, ABI, el shim de Secure Boot y la matriz de hardware.',
    'VERSÃO ESTÁVEL':'VERSIÓN ESTABLE','EOL · ESTIMATIVA':'FIN DE VIDA · ESTIMACIÓN','Fim de suporte da Lyra OS 1.1':'Fin del soporte de Lyra OS 1.1',
